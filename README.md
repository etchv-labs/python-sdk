...
Version 0.8.0 supports native image, PDF and video results. Use the returned filename
...
Version 0.8.0 adds storage destination and object-key options to image,
